...
situations we have L<Macros> in the phrasebook.
...
in parameters. Some examples proably help:
...
This is nothing more fancy than issueing the appropriate CLI commands to close
